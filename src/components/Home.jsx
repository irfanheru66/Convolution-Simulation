...
import ImageBanner2 from '../assets/img/image-banner-2.png'
                    ...
                    <div className="col-lg-6 col-md-12 intro">
                        ...
                        <div className="d-flex">
                            <div className="hero-caption" style={{ marginTop: 30 + 'px' }}>
                                <h1 className="text-o-primary font-weight-bold my-4 aos-init aos-animate" data-aos="fade-up"
                                    data-aos-delay="0">Image Convolution Simulation</h1>
                                <p className="text-o-primary mb-4 aos-init aos-animate w-75" style={{ letterSpacing: 1.7 + 'px', lineHeight: 1.7 }} data-aos="fade-up"
                                    data-aos-delay="100">
